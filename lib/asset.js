...
var Asset = module.exports = Waiter.extend({
   ...
   */
  init: function init(location, stat, load) {
    var self = this;
  ...
  /**
   * Perform a string replace inside the asset's contents.
   */
  replace: function (pattern, replacement) {
    var self = this;
    ['content', 'compiledContent', 'minifiedContent'].forEach(function (key) {
